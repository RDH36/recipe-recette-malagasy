...
const Congratulations = () => {
  ...
  useEffect(() => {
    // Déclencher les confettis après un court délai pour laisser la page se charger
  ...
  return (
    <View className="flex-1 bg-white">
      ...
      <View className="p-4 gap-2">
        ...
        <TouchableOpacity className="flex-row gap-2 justify-center bg-primary py-4 rounded-xl items-center">
